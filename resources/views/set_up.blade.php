<div class="card text-center" style="padding:30px 0;">
	...
	<div class="row justify-content-center" style="margin-top:20px;">
		<div class="col-5">
			...
			<a href="#profiles" class="btn btn-primary" data-toggle="modal" data-target="#profilesModal">Add profiles</a>
		</div>
	</div>
	...
	<div class="row justify-content-center" style="margin-top:40px;">
		<div class="col-5">
			...
			<a href="{{ route('slack.login') }}" class="btn btn-primary">Connect to Slack</a>
		</div>
	</div>
</div>
